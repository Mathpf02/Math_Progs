...
<head>
    ...
    <link rel="stylesheet" href="../assets/style/regis/style.css">
    <title>Cadastrar-se | DVP (discord versão paraguai)</title>
</head>
...
<body>
    ...
    <div class="boyd_login">
        <div class="area_login">
            <form method="post" enctype="multipart/form-data" action="../assets/script/php/cadastrar_se.php">
                <div class="area_1">
                    ...
                    <div class="input_area">
                            ...
                            <div class="input_l">
                                <input type="file" autocomplete="off" class="input_l_file" name="imagem_u">
                            </div>
                        </div>
                        <div class="input_area">
                            <div class="input_title">
                            ...
                            <div class="input_l">
                                <input type="text" autocomplete="off" class="input_l_ele" name="email">
                            </div>
                        </div>
                        <div class="input_area">
                            <div class="input_title">
                            ...
                            <div class="input_l">
                                <input type="text" autocomplete="off" class="input_l_ele" name="nome">
                            </div>
                        </div>
                        <div class="input_area">
                            <div class="input_title">
                            ...
                            <div class="input_l">
                                <input type="text" autocomplete="off" class="input_l_ele" name="tel">
                            </div>
                        </div>
                        <div class="input_area">
                            <div class="input_title">
                            ...
                            <div class="input_l">
                                <input type="password" class="input_l_ele senha" name="senha">
                            </div>
                        ...
                        <div class="input_area">
                            ...
                            <div class="input_l">
                                <input type="password" autocomplete="off" class="input_l_ele senhac" name="senhaC">
                            </div>
                            <?= error()?>
                        </div>
                    </div>
                    <div class="area_button">
                        <div class="button_area disabled_error">
                            <button type="submit">Continuar</button>
                        </div>
                        <div class="register_area">
                            <a href="../" class="minha_senha_a">Já tenho uma conta.</a>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <script type="text/javascript" src="../assets/script/javascript/regis.js"></script>
</body>
