...
<body>
    ...
    <div class="boyd_login">
        <div class="area_login">
            <form method="post" action="assets/script/php/login.php">
                <div class="area_1">
                    <div class="title_login">
                        <div class="title_grn">
                            Boas-vindas de volta!
                        </div>
                        <div class="title_menor">
                    ...
                    <div class="area_inputs">
                        ...
                        <div class="input_area">
                            ...
                            <div class="input_l">
                                <input type="password" class="input_l_ele" name="pass">
                            </div>
                            <div class="minha_senha">
                                <a href="paginas/recuperar_senha.php" class="minha_senha_a">Esqueceu sua senha?</a> 
                            </div>
                            <?= error()?>
                        </div>
                    </div>
                    <div class="area_button">
                        ...
                        <div class="register_area">
                            Precisando de uma conta? <a href="paginas/cadastrar_se.php" class="minha_senha_a">Registre-se</a>
                        </div>
                    </div>
                </div>
            </form>
            <div class="area_qr">
                ...
                <div class="text_generic_">
                    <div class="title_qr">
                        Entrar com Código QR
                    </div>
                    <div class="text_ale">
                        Escaneie isto com o <b>app móvel do Discord</b> para fazer login imediatamente.  <!--MENSAGEM PARA DEIXAR O MAIS PARECIDO COM O DISCORD -->
                    </div>
                </div>
            </div>
        </div>
