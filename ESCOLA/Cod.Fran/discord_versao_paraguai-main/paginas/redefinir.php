<?php
session_start();
require_once '../assets/script/php/conect.php';

$email = $pdo->escape_string($_GET['email']);
$token = $pdo->escape_string($_GET['token']);

$sql_p = $pdo->query("SELECT * FROM list_senha_reset WHERE email='" . $email ."' AND token='".$token."'")->fetch_assoc();

if (!is_null($sql_p)) {
    $hoje = new DateTime();
    $data_expiracao = new DateTime($sql_p['dataExpiracao']);
    if ($hoje < $data_expiracao) {} else {
        $_SESSION['error'] = true;
...
<head>
    ...
    <title>Login | DVP (discord versão paraguai)</title>
</head>

<body>
    <!-- pego na tela de login do Discord -->
    <svg class="artwork-L5TAwQ" preserveAspectRatio="xMinYMin slice" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1700 1200">
        <defs>
            <linearGradient id="linear-gradient" x1="269.71" x2="269.71" y1="800.4" y2="913.29" gradientUnits="userSpaceOnUse">
                <stop offset="0" stop-color="#50cc7a"></stop>
    ...
    <!-- svg acima foi tirado do proprio site do Discord -->

    <div class="boyd_login">
        <div class="area_login" style="height: auto;">
            <form method="post" action="../assets/script/php/recuperar_senha_et2.php">
                <input type="hidden" value="<?= $_GET['email']?>" type="text" name='email'>
                <input type="hidden" value="<?= $_GET['token']?>" type="text" name='token'>
                <div class="area_1">
                    ...
                    <div class="area_inputs">
                        <div class="input_area">
                            ...
                            <div class="input_l">
                                <input type="password" autocomplete="off" required class="input_l_ele" name="senha">
                            </div>
                        </div>
                        <div class="input_area">
                            <div class="input_title">
                            ...
                            <div class="input_l">
                                <input type="password" autocomplete="off" required class="input_l_ele" name="senha_c">
                            </div>
                        </div>
                    </div>
    ...
    <script type='text/javascript'>
            let inp = document.querySelectorAll('.input_l_ele');
            inp.forEach((element)=>{
            ...
            } else if(inp[1].value != '' && inp[0].value != ''){
